...
public class UpdateCustomer extends JFrame implements ActionListener {
    ...
    // Constructor for the Update Customer class
        UpdateCustomer(String username) {
        // Set the frame dimensions and layout    
        ...
        ImageIcon il = new ImageIcon(ClassLoader.getSystemResource("icons/update.jpg"));
        ...
        try {
            // Retrieve customer details from the database and populate the fields
            DBConn c = new DBConn();
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            // Get updated customer details from text fields
